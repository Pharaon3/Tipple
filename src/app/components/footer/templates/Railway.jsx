...
class RailwayFooter extends Component {
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-12 col-md-6">
                ...
                <p>Under the Liquor Control Reform Act 1998 it is an offence to supply alcohol to a person under the age of 18 years (penalty exceeds $17,000), for a person under the age of 18 years to receive liquor (penalty exceeds $700).</p>

                <p>Victorian Liquor Licence - ALBERT STREET HOTEL PTY LTD, Late Night (general) Liquor Licence No. 31911563</p>

                <p>All alcohol sales made on this site are sales which occur and are appropriated in Victoria.</p>
          </div>
        </div>
      </div>
    </footer>]
...
export default connect(mapStateToProps, mapDispatchToProps)(ssrComponent(withRouter(RailwayFooter)));