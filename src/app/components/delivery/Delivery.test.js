...
import { tieredDeliveryMethods as sampleDeliveryMethods, warehouseDeliveryMethods as sampleWarehouseDeliveryMethods } from 'lib/../../tests/sampleData/deliveryMethods';
import { cart as sampleCart } from 'lib/../../tests/sampleData/cart';
import { findFirstValidTieredDeliveryDay } from 'lib/util/delivery';
...
it('should render Delivery with given props', () => {
